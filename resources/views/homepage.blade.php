                ...
                <div class="container px-lg-5">
                    <div class="row g-5 align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="/login" class="btn btn-secondary py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">Login</a>
                            <a href="/register" class="btn btn-light py-sm-3 px-sm-5 rounded-pill animated slideInRight">Daftar</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-start">
